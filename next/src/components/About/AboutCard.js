    ...
    return (
        <div className="group relative">
            ...
            <div className="relative overflow-hidden">
                <div className="absolute w-full h-full  top-0 transition-all group-hover:top-full"> 
                    <Image src="/images/placeholder-1.png" width={400} height={450} layout="responsive" className="object-fill"  />
                </div>
                <div className="bg-light-gray text-center py-5 px-10 min-h-[400px] text-white flex justify-center items-center  ">
                    <p>{desc}</p>
                </div>
            </div>
        </div>
